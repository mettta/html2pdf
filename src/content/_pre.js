const code = `<pre style="white-space: break-spaces; padding: 10px; background: #ddd">
...
if (ratio > this.imageReductionRatio) {
  ...
  this.DOM.fitElementWithinBoundaries({
    ...
    height: this.DOM.getElementHeight(currentImage) this.DOM.getElementHeight(currentImage),
