...
class Test(BaseCase):
    ...
    def test_01(self):
        ...
        self.helper.assert_element_on_the_page(title1, 2, True)
    ...
    def test_02(self):
        ...
        self.helper.assert_element_starts_page(title1, 2)
        self.helper.assert_element_on_the_page(title1, 2, True)
        self.helper.assert_element_on_the_page(title2, 2, True)
        self.helper.assert_element_on_the_page(p1, 2, True)
    ...
    def test_03(self):
        ...
        self.helper.assert_element_on_the_page(title1, 2, True)
        self.helper.assert_element_on_the_page(title2, 2, True)
        self.helper.assert_element_on_the_page(title3, 2, True)
        self.helper.assert_element_on_the_page(title4, 2, True)
        self.helper.assert_element_on_the_page(title5, 2, True)
        self.helper.assert_element_on_the_page(title6, 2, True)
        self.helper.assert_element_starts_page(title7, 3)
        self.helper.assert_element_on_the_page(title7, 3, True)
        self.helper.assert_element_on_the_page(title8, 3, True)
    ...
    def test_04(self):
        ...
        self.helper.assert_document_has_pages(2, True)
        self.helper.assert_element_on_the_page(title1, 1, True)
        self.helper.assert_element_on_the_page(title2, 1, True)
        self.helper.assert_element_on_the_page(title3, 1, True)
        self.helper.assert_element_on_the_page(title4, 1, True)
        self.helper.assert_element_on_the_page(title5, 1, True)
        self.helper.assert_element_on_the_page(title6, 1, True)
        self.helper.assert_element_starts_page(title7, 2)
        self.helper.assert_element_on_the_page(title7, 2, True)
        self.helper.assert_element_on_the_page(title8, 2, True)
        self.helper.assert_element_on_the_page(p1, 2, True)
