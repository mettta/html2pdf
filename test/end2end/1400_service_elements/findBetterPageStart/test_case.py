...
class Test(BaseCase):
    ...
    def test_01(self):
        ...
        self.helper.assert_element_on_the_page(title1, 2, report=True)
    ...
    def test_02(self):
        ...
        self.helper.assert_element_starts_page(title1, 2)
        self.helper.assert_element_on_the_page(title1, 2, report=True)
        self.helper.assert_element_on_the_page(title2, 2, report=True)
        self.helper.assert_element_on_the_page(p1, 2, report=True)
    ...
    def test_03(self):
        ...
        self.helper.assert_element_on_the_page(title1, 2, report=True)
        self.helper.assert_element_on_the_page(title2, 2, report=True)
        self.helper.assert_element_on_the_page(title3, 2, report=True)
        self.helper.assert_element_on_the_page(title4, 2, report=True)
        self.helper.assert_element_on_the_page(title5, 2, report=True)
        self.helper.assert_element_on_the_page(title6, 2, report=True)
        self.helper.assert_element_starts_page(title7, 3)
        self.helper.assert_element_on_the_page(title7, 3, report=True)
        self.helper.assert_element_on_the_page(title8, 3, report=True)
    ...
    def test_04(self):
        ...
        self.helper.assert_document_has_pages(2, report=True)
        self.helper.assert_element_on_the_page(title1, 1, report=True)
        self.helper.assert_element_on_the_page(title2, 1, report=True)
        self.helper.assert_element_on_the_page(title3, 1, report=True)
        self.helper.assert_element_on_the_page(title4, 1, report=True)
        self.helper.assert_element_on_the_page(title5, 1, report=True)
        self.helper.assert_element_on_the_page(title6, 1, report=True)
        self.helper.assert_element_starts_page(title7, 2)
        self.helper.assert_element_on_the_page(title7, 2, report=True)
        self.helper.assert_element_on_the_page(title8, 2, report=True)
        self.helper.assert_element_on_the_page(p1, 2, report=True)
